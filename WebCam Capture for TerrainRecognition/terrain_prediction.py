...
# contains all testing functions
BATCH_SIZE: int = 32
IMG_SIZE = 224
...
def download_image(url):
    ...
    with open("files/downloaded_image.jpg", "wb") as file:
        file.write(content)
        return "files/downloaded_image.jpg"
...
def create_data_batches(X, y= None, batch_size: int= BATCH_SIZE, valid_data: bool= False, test_data: bool= False):
    ...
    if test_data:
        print('Creating test data batches...') # for confirmation
...
def get_pred_label(prediction_probabilities):
    ...
    labels_csv = pd.read_csv(r"/Users/nirmalkumar/Desktop/4. WebCam Capture for TerrainPrediction/dataset/TerrainDataset - Sheet1.csv")
